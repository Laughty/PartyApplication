...
class CoreDataService {
    ...
    private func cleanRecordForEntity(name:FetchDetail){
        ...
        case .initData:
            var fetch = NSFetchRequest<NSFetchRequestResult>(entityName: FetchDetail.friendList.rawValue)
            ...
            fetch = NSFetchRequest<NSFetchRequestResult>(entityName: FetchDetail.partyList.rawValue)
